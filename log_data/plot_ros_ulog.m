...
figure,
subplot(3,1,1);
plot(time_ros(:,1)+39.6,ros_Roll*r2d,'r-');hold on;
...
legend('ros','px4','visual');
subplot(3,1,2);
plot(time_ros(:,1)+39.6,ros_Pitch*r2d,'r-');hold on;
...
ylabel('Pitch (deg)')
subplot(3,1,3);
plot(time_ros(:,1)+39.6,ros_Yaw*r2d,'r-');hold on;
...
figure,
subplot(3,1,1);
plot(time_ros(:,1)+39.6,ros_xyz(:,1),'r-');hold on;
...
subplot(3,1,2);
plot(time_ros(:,1)+39.6,ros_xyz(:,2),'r-');hold on;
...
ylabel('Y (m)')
subplot(3,1,3);
plot(time_ros(:,1)+39.6,ros_xyz(:,3),'r-');hold on;
